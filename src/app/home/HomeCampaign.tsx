...
const HomeCampaign = () => {
  return (
    <div className="bg-color md:full flex h-screen items-end justify-center overflow-hidden md:justify-end">
      <div className="flex h-full w-full flex-col">
        <div className="relative h-full w-full ">
          <div className="px-12 lg:px-60">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              support from businesses, cities, regions, investors, and citizens
              for a healthy, resilient, and zero-carbon future. The campaign is
              driven by the United Nations Framework Convention on Climate
              Change (UNFCCC) and its partners, with the overarching goal of
              achieving net-zero greenhouse gas emissions by 2050 at the latest.
            </motion.p>
          </div>
          <motion.div
            className="absolute bottom-[-200px] flex w-full items-end justify-center"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
